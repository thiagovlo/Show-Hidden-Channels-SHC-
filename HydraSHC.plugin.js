 ...
 * @version 0.4.1
 * @author hydrascript
 * @authorId 223801077521186816
 * @source https://github.com/thiagovlo/Show-Hidden-Channels-SHC-.git
 * @description Um plugin que exibe todos os canais ocultos e permite aos usuários visualizar informações sobre eles, isso não permitirá que você os leia ou se conectem (impossível).
*/
...
const config = {
  info: {
    ...
    description: "Um plugin que exibe todos os canais ocultos e permite aos usuários visualizar informações sobre eles, isso não permitirá que você os leia ou se conectem (impossível).",
    version: "0.4.1",
    github: "https://github.com/thiagovlo/Show-Hidden-Channels-SHC-.git",
  ...
  changelog: [
    ...
    },
    {
      ...
      items: [
        ...
        "Fixed collapsing for Bottom Category sorting"
      ]
    },
    {
...
class MissingZeresDummy {
  ...
  getSettingsPanel() {
    //Fecha o painel de configurações e mostra o modal para baixar o ZLib
    const buttonClicker = document.createElement("hydra");
    buttonClicker.addEventListener("DOMNodeInserted", () => {
     // Oculta o painel de configurações para evitar que ele apareça antes do modal
      ...
      // Mostrar modal para baixar ZLib
      this.downloadZLibPopup();
    });
  ...
  async downloadZLib() {
    ...
    require("request").get("https://betterdiscord.app/gh-redirect?id=9", async (err, resp, body) => {
      ...
      // Se a resposta for um redirecionamento para o arquivo real
      ...
      // Se a resposta for o arquivo real
      } else {
...
module.exports = !global.ZeresPluginLibrary ? MissingZeresDummy : (([Pl, Lib]) => {
  const plugin = (Plugin, Library) => {
    ...
    const UsedModules = {
      ...
      /* Módulos encontrados manualmente */
      GuildStore,
      DiscordConstants,
      chat,
      Route,
    ...
    return class ShowHiddenChannels extends Plugin {
      ...
      Patch() {
        // Verifique os módulos necessários
        ...
        //* Parar de buscar mensagens se o canal estiver oculto
        ...
        //* Remover ícone de cadeado de canais de voz ocultos
        ...
        //* Recolher manualmente a categoria de canal oculto
        ...
        //* Categoria personalizada ou ordem de classificação
        ...
        //* adicionar entrada no menu de contexto do server
          ...
          return React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                "Você não pode ver os conteúdos deste canal. ",
              ...
              props.channel.permissionOverwrites &&
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    "Usuários que podem ver esse canal: ",
                    React.createElement(
                      "div",
                      {
                        style: {
                    ...
                    React.createElement(
                      ...
                      ...(() => {
                        const channelRoles = Object.values(props.channel.permissionOverwrites).filter(role => 
                          ...
                          //* 1024n = VIEW_CHANNEL permissão
                          //* 8n = ADMINISTRATOR permissão
                          ( 
                            //* Se a função for ADMINISTRATOR, ele poderá visualizar o canal mesmo se substituir, negar VIEW_CHANNEL
                            (this.settings["showAdmin"] && ((props.guild.roles[role.id].permissions & BigInt(8)) == BigInt(8))) ||

                            //* Se as substituições permitirem VIEW_CHANNEL (isso substituirá as permissões de função padrão)
                            ((role.allow & BigInt(1024)) == BigInt(1024)) ||

                            //* Se a função puder visualizar o canal por padrão e substituir, não nega VIEW_CHANNEL
